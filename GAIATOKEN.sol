...
contract Pausable is Ownable {
	...
	modifier whenNotPaused() {
		require(!paused,"Check whether it is not paused");
		_;
	}

	modifier whenPaused() {
		require(paused,"Check whether it is paused");
		_;
	}
...
contract PauserRole {
	...
	modifier onlyPauser() {
		require(isPauser(msg.sender), "Check whether it is stopped");
		_;
	}
...
contract GAIA is BurnableToken, DetailedERC20, ERC20Token,Pausable{
	using SafeMath for uint256;
	...
	string public constant symbol = "GAIA";
 	string public constant name = "GAIA";
